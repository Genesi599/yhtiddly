...
public final class MetaDao_Impl implements MetaDao {
  ...
  @Override
  public Object set(final MetaEntity entry, final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      ...
      public Unit call() throws Exception {
        ...
        try {
          __insertionAdapterOfMetaEntity.insert(entry);
  ...
  public Object get(final String key, final Continuation<? super String> $completion) {
    final String _sql = "SELECT value FROM meta WHERE key = ? LIMIT 1";
